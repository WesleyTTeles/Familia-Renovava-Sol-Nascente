...
function send($nome, $fone, $email, $datanascimento, $estadocivil, $situacao){

    $query = "insert into alunos_dna (nome, fone, email, datanascimento, estadocivil, situacao) 
                values ('{$nome}', '{$fone}', '{$email}', '{$datanascimento}', '{$estadocivil}', '{$situacao}')";
